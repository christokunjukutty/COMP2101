...
#     then delete the local copy of the tarfile if the extraction was successful
test -f ~/public_html/pics/pics.tgz || wget -q -O ~/public_html/pics/pics.tgz https://zonzorp.net/pics.tgz file.
test -f ~/public_html/pics/pics.tgz && tar -xvf  ~/public_html/pics/pics.tgz -C ~/public_html/pics/  && rm ~/public_html/pics/pics.tgz
