...
echo "An Unknown Error has occurred" >&2
}
...
echo "HELP"
CAT <<EOF
This script produces a report.
This report will show you details of the following:
hostname
LAN Address
LAN name
External IP
...
Network Name
Network Address
and information on the disk usage, cpu, memory, and os.

You can use the following options for further info:
--help, -h, --domain, --disk
--ipconfig, --os, --cpu, --memory, --printer
