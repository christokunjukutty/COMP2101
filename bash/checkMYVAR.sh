#!/bin/bash
# This script demonstrates testing if a variable named MYVAR
# exists and whether it is empty
# It is expected that you use this script to test if MYVAR
# is inherited from a parent process
