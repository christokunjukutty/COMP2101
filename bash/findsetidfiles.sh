...
echo " "
echo "DISPLAY THE 12 LARGEST REGUlAR FILES IN THE SYSTEM SORTED BY THEIR SIZES"
echo "========================================================================="
find / -type f -exec ls -l --block-size=M {} + 2>/dev/null | sort -n -r -k7 | awk '{print $3 " " $5 " " $9}' | head -12
exit
